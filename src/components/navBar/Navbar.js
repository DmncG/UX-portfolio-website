          ...
          ? (
            ...
            <AppBar classes={{ root: classes.rootAppBar }} position="sticky">
              <Toolbar classes={{ root: classes.rootToolbar }}>
                ...
                <div>
                  <Link to="/">
                    <StaticImage placeholder="blurred" className="w-16 m-2" src="../../images/dom_new_logo_white.png" alt="drg logo" />
                  </Link>
                </div>
              </Toolbar>
            </AppBar>
            ...
            <React.Fragment>
              ...
              >
                ...
                <motion.div variants={itemVariants} className="flex justify-center">
                  <Link to="/">
                    <StaticImage placeholder="blurred" className="w-20 block mx-auto" src="../../images/dom_new_logo_white.png" alt="drg logo" />
                  </Link>
                </motion.div>
