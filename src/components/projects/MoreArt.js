    ...
    <div className="max-w-screen-md xl:max-w-screen-lg md:mx-auto py-16">
      ...
      <div>
        <section>
          ...
          <div className="md:grid md:grid-cols-2 md:justify-center md:items-start">
            <div className="py-2 px-4 my-2">
              <h2 className="font-display font-semibold text-2xl my-2">Background</h2>
            ...
            <div className="py-2 px-4 my-2">
              <h2 className="font-display font-semibold text-2xl my-2">Objectives</h2>
            ...
            <div className="py-2 px-4 my-2">
              <h2 className="font-display font-semibold text-2xl my-2">My Role</h2>
              <p className="font-body text-base leading-relaxed">UX Designer, team of 3</p>
            </div>

            <div className="py-2 px-4 my-2">
              <h2 className="font-display font-semibold text-2xl my-2">Timeline</h2>
              <p className="font-body text-base leading-relaxed">Two weeks</p>
            </div>

            <div className="py-2 px-4 my-2">
              <h2 className="font-display font-semibold text-2xl my-2">Tools</h2>
        ...
        <section>
          ...
          <div>
            <div className="py-2 px-4 my-2">
              <h2 className="font-display font-semibold text-2xl my-2">Research Interviews</h2>
              ...
              <div className="grid grid-cols-2 justify-center my-8">
                <StaticImage src="../../images/moreart-interview-1.png" alt="research interview 1" />

                <StaticImage src="../../images/moreart-interview-2.png" alt="research interview 1" />

                <StaticImage src="../../images/moreart-interview-3.png" alt="research interview 1" />

                <StaticImage src="../../images/moreart-interview-4.png" alt="research interview 1" />
              </div>
            </div>
          </div>
        </section>
